                        ...
                        <td style="padding: 40px 0px 0px;">
                          ...
                          <div style="padding: 20px; background-color: rgb(255, 255, 255);">
                            <div style="color: rgb(0, 0, 0); text-align: left;">
                              ...
                              <p style="padding-bottom: 16px">${data.Name} Thank you for choosing BB Buyer Brand. Use the following OTP to complete your Registration procedures. OTP is valid for 5 minutes</p>
...
const otpVerify = (req,res)=>{
  const { _id } = req.user;
  const {otp} = req.body
  otpVerification.findOne({UserId:_id}).then((data)=>{ 
    if (Number(data.expireAt)<Date.now()){
      
    }else{
      errHandler(res,"your otp in expire")
    }
  })
}
